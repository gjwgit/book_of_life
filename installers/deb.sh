...
Description: Collect your lifes documents privately
 With ${APP} your lifes documentation can be stored and encrypted, in your Pod.
 The app can also provides be a template for other Solid Pods based apps.
EOL
